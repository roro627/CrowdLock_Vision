...
def run_benchmark(device: str, duration_sec: int = 10, resolution: tuple = (1920, 1080), inference_width: int = 640, optimize: bool = False):
    print(f"\n{'='*50}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--duration", type=int, default=10, help="Benchmark duration in seconds per device")
    ...
    parser.add_argument("--optimize", action="store_true", help="Enable model optimization (ONNX for CPU)")
    parser.add_argument("--device", type=str, default="all", help="Device to run on (cpu, cuda, or all)")
